...
function makeSetOfCellsWhichShouldToggleSpecs () {
...
function evaluateLivingCellsSpecs() {
...
function evaluateDeadCellsSpecs() {
...
export default () => {
  ...
  makeSetOfCellsWhichShouldToggleSpecs();
  evaluateLivingCellsSpecs();
  evaluateDeadCellsSpecs();
}
